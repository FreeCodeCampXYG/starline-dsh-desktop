...
> v0.5.0 已通过六平台原生 CI、最终离线归档功能复测和 Ubuntu 24.04 x64/ARM64 DEB 安装门禁并公开发布，但仍不代表代表性设备上的安装、首次启动、升级和卸载全部通过。证据边界与 v0.2.4 历史缺陷见 [已知问题与平台支持边界](KNOWN_ISSUES.md)；任何修复都发布递增版本，不移动已有公开 tag。

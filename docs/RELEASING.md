...
.\scripts\prepare-dsh-release.ps1 -DSHVersion 0.1.5-rc.1 -DesktopVersion 0.6.21 -Commit -Tag -Push
# 只准备并查看差异时省略 -Commit/-Tag/-Push；审阅后请手工提交和打 tag。
.\scripts\prepare-dsh-release.ps1 -DSHVersion 0.1.5-rc.1 -DesktopVersion 0.6.21
```
